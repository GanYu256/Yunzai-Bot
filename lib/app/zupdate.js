...
export async function checkupdate (e) {
  ...
  let url = "https://api.github.com/repos/GanYu256/Yunzai-Bot"; //git地址
  let msg =
...
export async function setUpdatetime (e) {
  ...
  url = "https://api.github.com/repos/GanYu256/Yunzai-Bot/commits";
...
export async function updateLog (e) {
  ...
  let url = "https://api.github.com/repos/GanYu256/Yunzai-Bot/contents/resources/readme/更新日志.md?ref=master"; //git地址
  let response = await fetch(url); //调用接口获取数据
  let res = await response.json(); //结果json字符串转对象
